  ...
  return (
    <div className="intro_div">
      ...
      <p className="intro_story">
        ...
        right, and one in particular, Sigma Shipyards, has asked you to lead
        construction of their fleet. They have three star systems selected
        already. All you have to do is choose a system, and build a suitable
        ship to reach it. Will you be the one to save humanity? ..Do you even
        have a choice...?{" "}
      </p>
